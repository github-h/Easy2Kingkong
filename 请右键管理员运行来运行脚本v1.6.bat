@echo off
echo -----------------------------------------------------------------------------------------
echo 本脚本由付导的录播组制作  当前版本为 V1.6 （20200201）
echo.
echo 请勿二改 大量传播 本脚本只解决当前的DNS污染问题 若该脚本失效请关注群动态或UP教程视频简介
echo.
...
set a=13.33.174.8 www.kingkong.com.tw
set b=13.32.52.27 m.kingkong.com.tw
set c=99.86.144.55 static.kingkong.com.tw
set d=13.224.161.65 img.kingkong.com.tw

set n=99.84.143.91 api.kingkongapp.com
set o=13.32.52.36 www.kingkongapp.com

set p=157.240.15.22 connect.facebook.net
...
echo.
set /p choice=1.优化kingkong 2.恢复hosts文件 3.打开kingkong主页 4.退出 0.【免优化】直接打开kingkong(该网站能用多久不知道)
echo.
